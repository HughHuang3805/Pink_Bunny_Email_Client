...
public class GmailClient {
	...
	public static void main(String[] args) {
		...
		String mailFrom=new String("hughxq@gmail.com");

		//Sender must be a Gmail Account holder

		String mailTo=new String("quan289243805@hotmail.com");

		//but here you can send to any type of mail account

		String senderPassword=new String("hxq3362362");

		String senderUserName=new String("hughxq@gmail.com");
